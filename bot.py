#ساخته شده توسط سون(ممد)
#روبیکا: strik_bot
print('created mmd (seven) \n \n')
import asyncio
import base64
...
g_usvl = ''
test_usvl = ''
auth = "tqtigdlnnbkboaarrpsmvtonogdwwxgp"
bot = Bot(auth)
list_message_seened = []
                    ...
                    if 'SendMessages' in access and chat['last_message']['type'] == 'Text' and text.strip() != '':
                        ...
                        if not m_id in list_message_seened:
                            ...
                            if text == '!start' or text == '/start' or text == 'شروع' or text == 'استارت':
                                ...
                                try:
                                    bot.sendMessage(chat['object_guid'], 'سلام دوست عزیز. \n به استریک بات خوش اومدی🚭🧡 \n برای دریافت لیست دستورا‌ت کلمه زیر را بفرستید تابرای شما ارسال گردد \n /help \n کانال ما جوین اجباری @STERIK_BOT ',chat['last_message']['message_id'])
                                    print('sended response')    
                                except:
                                    print('server bug1')
                            ...
                            if text == '.' or text == '‌' or text == '‌.‌' or text == '.‌' or text == '‌.‌.' or text == '۰':
                                ...
                                try:
                                    ...
                                    bot.sendMessage(chat['object_guid'], 'باباش واسش نت نمیخره😂‌',chat['last_message']['message_id'])
                                    print('sended response')    
                                except:
                                    print('server bug1')
                            if text == 'چخبر' or text == 'چه خبر' or text == 'چ خبر' or text == 'جخبر' or text == 'چهخیر' or text == 'چح خبر':
                                ...
                                try:
                                    ...
                                    bot.sendMessage(chat['object_guid'], 'سلامتی عشقم',chat['last_message']['message_id'])
                                    print('sended response')    
                                except:
                                    print('server bug1')
                            if text == 'ربات' or text == 'رباط' or text == 'روبات' or text == 'بات' or text == 'روباط' or text == 'استریک':
                                print('message geted and sinned')
                                try:

                                    bot.sendMessage(chat['object_guid'], 'جونم نفسم?💙📿',chat['last_message']['message_id'])
                                    print('sended response')    
                                except:
                                    print('server bug1')

                            if text == '😂' or text == '😁' or text == '🙂' or text == '🤣' or text == '😃' or text == '😅' or text == 'خ' or text == 'خخ' or text == 'خخخ' or text == 'خخخخ' or text == 'خخخخخ' or text == 'خخخخخخ':
                                print('message geted and sinned')
                                try:

                                    bot.sendMessage(chat['object_guid'], 'جووون واسه خنده هات',chat['last_message']['message_id'])
                                    print('sended response')    
                                except:
                                    print('server bug1')
                            if text == 'گمشو' or text == 'برو بابا' or text == 'آجر پاره' or text == 'نکمه' or text == 'سس ماست' or text == 'بیا پایین' or text == 'بچه بیا پایین' or text == 'پیدرت' or text == 'خز' or text == 'لفت بده' or text == 'لف بده' or text == 'بلف':
                                print('message geted and sinned')
                                try:

                                    bot.sendMessage(chat['object_guid'], 'هرهرهر خندیدیم😒',chat['last_message']['message_id'])
                                    print('sended response')    
                                except:
                                    print('server bug1')
                            if text == 'خوبی' or text == 'خوبیح' or text == 'خویی' or text == 'خوبی؟' or text == 'خوبیح؟' or text == 'خبی':
                                ...
                                try:
                                    ...
                                    bot.sendMessage(chat['object_guid'], 'حال من تو حال تو تاثیری داره؟',chat['last_message']['message_id'])
                                    print('sended response')    
                                except:
                                    print('server bug1')
                            if text == 'سلام' or text == 'صل' or text == 'سیلام' or text == 'س' or text == 'صلام' or text == 'سل':
                                ...
                                try:
                                    ...
                                    bot.sendMessage(chat['object_guid'], 'سلام گٌل \n😁\n👕\n👖',chat['last_message']['message_id'])
                                    print('sended response')    
                                except:
                                    print('server bug1')
                            if text == '/zaman' :
                            ...
                            if text == 'تست' or text == 'test' or text == '!test' or text == '/test' or text == '/Test' or text == '!Test':
                                ...
                                try:
                                    ...
                                    bot.sendMessage(chat['object_guid'], 'strik on',chat['last_message']['message_id'])
                                    print('sended response')    
                                except:
                                    print('server bug1')
                            if text == 'لینک' or text == 'مدیر' or text == 'مدیر کیه' or text == 'لینک گپ' or text == 'کی مدیره' or text == 'ادمین' or text == 'سازنده':
                                print('message geted and sinned')
                                try:

                                    bot.sendMessage(chat['object_guid'], 'لینک گپ: @STERIK_BOT \n مدیر: @VASETEH_7 \n ریپ چته مدیر گپ بزن لینک بده',chat['last_message']['message_id'])
                                    print('sended response')    
                                except:
                                    print('server bug1')

...
class Main:
    ...
    def download(self,link:str) -> None:
        try:
            ...
            return wget.download(link,join(self.path,"gitstrik",link.split('/')[-1]))
        except Exception as error:self.method.sendMessage(self.myGuid,str(error));console.log(error)
        ...
        while True:
            try:
                ...
                if linkBool == None:
                    ...
                    self.method.sendMessage(self.myGuid,"اتمام آپلود توسط استریک")
